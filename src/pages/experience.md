...
- Member of the UX Team, the company's central frontend team responsible for all user-facing applications.
- Developed and maintained frontend features for the company's largest client using JavaScript, Svelte, Stencil, and React.
- Handled day-to-day bug fixing and feature development in a large-scale production environment.
- Integrated AQA sanity tests into the AQA project using Playwright, covering both mobile and desktop user flows.

**GamMatrix** (February 2024 – April 2025)
...
- Designed and implemented automated E2E testing infrastructure using Playwright.
- Coordinated and executed bi-weekly releases for the company's flagship product, Neve.
